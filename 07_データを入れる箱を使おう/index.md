...
![screenshot: variables.tsを作成](./images/create-variables-ts.png)
...
![screenshot: constの変更エラー](./images/const-error.png)
...
![screenshot: 型エラーの表示](./images/type-error.png)

### 入力補完が効く

変数の型がわかっていると、VSCodeが「使えるもの」を教えてくれます。

![screenshot: 入力補完](./images/autocomplete.png)
