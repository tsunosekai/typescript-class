...
![screenshot: Viteでプロジェクト作成](./images/vite-create.png)
...
![screenshot: npm install実行中](./images/npm-install.png)
...
![screenshot: 開発サーバー起動](./images/npm-run-dev.png)
...
![screenshot: Reactの初期画面](./images/react-initial.png)
...
![screenshot: プロジェクト構造](./images/project-structure.png)
...
![screenshot: 書き換え後の画面](./images/react-first-change.png)
...
![screenshot: プロフィール表示](./images/react-profile.png)
