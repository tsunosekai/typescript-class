...
![screenshot: VSCodeを起動する](./images/open-vscode.png)

### 1-2. VSCodeが開いた

このような画面が表示されればOKです。

![screenshot: VSCodeの起動画面](./images/vscode-opened.png)
...
![screenshot: ターミナルメニューの場所](./images/terminal-menu.png)

### 2-2. ターミナルが表示された

画面の下部に、ターミナルが表示されます。

![screenshot: ターミナルが開いた状態](./images/terminal-opened.png)
...
![screenshot: pwdコマンドを入力](./images/pwd-command.png)
...
![screenshot: lsコマンドの結果](./images/ls-command.png)
...
![screenshot: cdコマンドの実行](./images/cd-command.png)
...
![screenshot: cd ..コマンドの実行](./images/cd-back.png)
