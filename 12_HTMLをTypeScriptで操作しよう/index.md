...
![screenshot: コンパイル後のファイル](./images/compiled-js.png)
...
![screenshot: 開発者ツールのConsole](./images/devtools-console.png)
...
![screenshot: テキストが変更された](./images/text-changed.png)
...
![screenshot: スタイルが変更された](./images/style-changed.png)
