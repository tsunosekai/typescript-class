...
![screenshot: フォルダを開く](./images/open-folder.png)
...
![screenshot: style.cssを作成](./images/create-style-css.png)
...
![screenshot: h1が青くなった](./images/h1-blue.png)
...
![screenshot: いろいろなスタイルが適用された](./images/various-styles.png)
...
![screenshot: ボタンに余白と枠線が適用された](./images/button-styled.png)
...
![screenshot: クラスが適用された段落](./images/class-highlight.png)
...
次回は「**ページをレイアウトしよう（Flexbox）**」です。

今はすべての要素が**縦に並んでいる**だけですね。次回は **横に並べたり、中央に配置したり**、レイアウトを整える方法を学びます！
