...
![screenshot: フォルダーを開くメニュー](./images/open-folder-menu.png)

デスクトップにある `typescript-lesson` フォルダを選択して、「フォルダーの選択」をクリック

![screenshot: フォルダを選択](./images/select-folder.png)
...
![screenshot: index.htmlと入力](./images/index-html-filename.png)
...
![screenshot: HTMLコードを入力した状態](./images/html-basic-code.png)
...
![screenshot: 拡張機能アイコン](./images/extensions-icon.png)

### 5-2. Live Serverを検索する

検索ボックスに `Live Server` と入力

![screenshot: Live Server検索](./images/search-live-server.png)

### 5-3. インストールする

「**Live Server**」を見つけて「**Install**」をクリック

![screenshot: Live Serverインストール](./images/install-live-server.png)
...
![screenshot: Go Liveボタン](./images/go-live-button.png)
...
![screenshot: ブラウザで表示された結果](./images/browser-result.png)
...
![screenshot: いろいろなタグの表示結果](./images/various-tags.png)
