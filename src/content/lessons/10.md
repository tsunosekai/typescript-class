...
> **なぜ2つの書き方があるの？**
> アロー関数は**短く書ける**のと、**コールバック関数**（他の関数に渡す関数）で使いやすいからです。
> 実際のコードでは、短い処理はアロー関数、長い処理は通常の関数、と使い分けることが多いです。
> どちらで書いても動くので、好きな方を使ってOK！
