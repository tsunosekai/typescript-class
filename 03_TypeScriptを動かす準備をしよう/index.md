...
![screenshot: Node.js公式サイト](./images/nodejs-official.png)

### 1-2. LTS版をダウンロードする

**「LTS」と書かれた緑のボタン**をクリックします。

![screenshot: LTSダウンロードボタン](./images/nodejs-download.png)
...
![screenshot: Node.jsインストーラー](./images/nodejs-installer.png)

### 1-4. インストールを進める

「Next」をクリックしながら進めます。特に設定を変える必要はありません。

![screenshot: インストール中の画面](./images/nodejs-installing.png)

### 1-5. インストール完了

「Finish」をクリックして完了です。

![screenshot: インストール完了画面](./images/nodejs-complete.png)
...
![screenshot: VSCodeを起動](./images/open-vscode.png)
...
![screenshot: ターミナルを開く](./images/open-terminal.png)
...
![screenshot: node -v コマンド](./images/node-version.png)
...
![screenshot: mkdirコマンド](./images/mkdir-command.png)
...
![screenshot: code . コマンド](./images/code-dot-command.png)
...
![screenshot: npm init コマンド](./images/npm-init.png)
...
![screenshot: npm install コマンド](./images/npm-install-ts.png)
...
![screenshot: 新しいファイルアイコン](./images/new-file-icon.png)
...
![screenshot: hello.tsと入力](./images/hello-ts-filename.png)
...
![screenshot: コードを入力した状態](./images/hello-code.png)

### 5-4. ファイルを保存する

**`Ctrl + S`** を押して、ファイルを保存します。

![screenshot: 保存後の状態（白丸が消える）](./images/file-saved.png)
...
![screenshot: プログラム実行コマンド](./images/run-hello.png)
...
![screenshot: Hello Worldの実行結果](./images/hello-result.png)
